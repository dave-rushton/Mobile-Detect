...
<title>Website Articles Category : <?php echo($SubObj) ? $SubObj->subnam : 'New Article Category'; ?></title>
...
<script src="website/js/article-category-edit.js"></script>
		...
		<div class="container-fluid">
			...
			<div class="page-header">
				...
				<div class="pull-left">
					...
					<h1>Website Articles Category</h1>
			...
			<div class="breadcrumbs">
				...
				<ul>
					...
					<li>
						...
						<a><?php echo(isset($SubObj)) ? $SubObj->subnam : 'New Article Category'; ?></a>
					...
					<div class="box box-color box-bordered" id="categoryBox">
						...
						<div class="box-title">
							...
							<h3>
								...
								<i class="icon-comments"></i> Website Article Category</h3>
						...
						<div class="box-content">
							...
							<form action="system/subcategories_script.php" id="subCategoriesForm" class="form-horizontal form-validate" data-returnurl="website/article-category.php">
								...
								<div class="control-group">
									...
									<label class="control-label">Article Category Name</label>
