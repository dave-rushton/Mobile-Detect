...
require_once 'service/apiServiceRequest.php';
  ...
  class AdunitsCustomchannelsServiceResource extends apiServiceResource {
    ...
    /**
     * List all events channels which the specified ad unit belongs to. (customchannels.list)
     *
     * @param string $adClientId Ad client which contains the ad unit.
     * @param string $adUnitId Ad unit for which to list events channels.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
     *
     * @opt_param string pageToken A continuation token, used to page through events channels. To retrieve the next page, set this parameter to the value of "nextPageToken" from the previous response.
     * @opt_param int maxResults The maximum number of events channels to include in the response, used for paging.
  ...
  class AccountsCustomchannelsServiceResource extends apiServiceResource {
    ...
    /**
     * List all events channels in the specified ad client for the specified account.
     * (customchannels.list)
     *
     * @param string $accountId Account to which the ad client belongs.
     * @param string $adClientId Ad client for which to list events channels.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
     *
     * @opt_param string pageToken A continuation token, used to page through events channels. To retrieve the next page, set this parameter to the value of "nextPageToken" from the previous response.
     * @opt_param int maxResults The maximum number of events channels to include in the response, used for paging.
    ...
    /**
     * Get the specified events channel from the specified ad client for the specified account.
     * (customchannels.get)
     *
     * @param string $accountId Account to which the ad client belongs.
     * @param string $adClientId Ad client which contains the events channel.
  ...
  class AccountsCustomchannelsAdunitsServiceResource extends apiServiceResource {
    ...
    /**
     * List all ad units in the specified events channel. (adunits.list)
     *
     * @param string $accountId Account to which the ad client belongs.
     * @param string $adClientId Ad client which contains the events channel.
  ...
  class CustomchannelsServiceResource extends apiServiceResource {
    ...
    /**
     * List all events channels in the specified ad client for this AdSense account.
     * (customchannels.list)
     *
     * @param string $adClientId Ad client for which to list events channels.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
    ...
    /**
     * Get the specified events channel from the specified ad client. (customchannels.get)
     *
     * @param string $adClientId Ad client which contains the events channel.
     * @param string $customChannelId Custom channel to retrieve.
     * @return CustomChannel
