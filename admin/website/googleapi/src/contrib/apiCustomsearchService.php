...
require_once 'service/apiServiceRequest.php';
  ...
  class CseServiceResource extends apiServiceResource {
    ...
    /**
     * Returns metadata about the search performed, metadata about the events search engine used for the
     ...
     * @opt_param string cx The events search engine ID to scope this search query
     ...
     * @opt_param string cref The URL of a linked events search engine
     * @return Search
     */
