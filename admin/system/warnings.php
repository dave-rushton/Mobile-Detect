...
$MsgDao = new MsgDAO();
$webcontacts = $MsgDao->select(NULL, $Atr_ID, 'WARNING', NULL, NULL, false);
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="box box-color box-bordered orange">
							<div class="box-title">
								<h3><i class="icon-warning"></i> Warnings</h3>
								<!--<div class="actions">
							...
							<div class="box-content nopadding">
								<ul class="tasklist">
									...
									<li class="<?php if ($webcontacts[$i]['sta_id'] == 1) { echo 'done'; } else if ($webcontacts[$i]['sta_id'] == 2) { echo 'bookmarked'; } ?>">
										...
										<a href="#modal-1" role="button" class="viewMessageLink" data-toggle="modal" data-atr_id="<?php echo $webcontacts[$i]['atr_id']; ?>"  data-tblnam="<?php echo $webcontacts[$i]['tblnam']; ?>"  data-tbl_id="<?php echo $webcontacts[$i]['tbl_id']; ?>"><span class="task"><span><?php echo ($attrGroupRec) ? $attrGroupRec->atrnam : '',' ',$webcontacts[$i]['msgttl'],' : ',$webcontacts[$i]['msgtxt']; ?></span></span></a>
