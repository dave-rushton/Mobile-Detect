...
$.ui.dynatree.nodedatadefaults = {
	...
	icon: null, // Use a events image (filename relative to tree.options.imagePath). 'null' for default icon, 'false' for no icon.
...
//  disabled: false,
	...
	// NOTE: we can also add events attributes here.
