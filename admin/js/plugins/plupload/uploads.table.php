...
<tr data-imageid="<?php echo $uploads[$i]['upl_id']; ?>">
	...
	<td><form action="<?php echo $patchworks->pwRoot; ?>gallery/uploads_script.php" class="form-horizontal" novalidate="novalidate">
			<input type="hidden" name="upl_id" value="<?php echo $uploads[$i]['upl_id']; ?>"  />
			<input type="text" name="uplttl" value="<?php echo $uploads[$i]['uplttl']; ?>" />
			<br />
	...
	<td><a href="#" class="btn btn-small updateImageButton" rel="<?php echo $uploads[$i]['upl_id']; ?>">update</a>
		<br />
		<a href="#" class="btn btn-small deleteImageButton" data-type="warning" rel="<?php echo $uploads[$i]['upl_id']; ?>"><i class="icon icon-remove"></i> delete</a></td>
</tr>
<?php } ?>
