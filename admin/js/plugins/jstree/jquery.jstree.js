		...
		_fn : { 
			...
			select_node : function (obj, check, e) {
				...
				if(proceed && !is_selected) {
					...
					//when node is selected populate content
					//alert(this.data.ui.selected.attr('id'));
					displayPage(this.data.ui.selected.attr('id').replace('node_',''));
				}
			},
	...
	$.jstree.plugin("themes", {
		...
		_fn : {
			set_theme : function (theme_name, theme_url) {
				...
				//theme_url = $.jstree._themes + theme_name + 'admin/css/tree.style.css'
				if(!theme_url) { theme_url = $.jstree._themes.replace("js/themes/","css/") + 'tree.style.css'; }
	...
	$.vakata.context = {
		...
		parse	: function (s, is_callback) {
			...
			$.each(s, function (i, val) {
				...
				if(val.icon && val.icon.indexOf("/") === -1) { str += " class='1" + val.icon + "' "; }
 ...
 * According to the type setting the node may get events icon/validation rules
 */
(function ($) {
	$.jstree.plugin("types", {
		__init : function () {
