		...
		<div class="container-fluid">
			...
			<div class="page-header">
				...
				<div class="pull-left">
					...
					<h1>Website Location Categories</h1>
			...
			<div class="breadcrumbs">
				...
				<ul>
					...
					<li>
						...
						<a href="admin/locations/location-categories.php">Location Categories</a>
					...
					<div class="box box-color box-bordered">
						...
						<div class="box-title">
							...
							<h3>
								...
								<i class="icon-comments"></i> Website Location Categories</h3>
							...
							<div class="actions">
								...
								<a href="locations/location-categories-edit.php?location_category_id=<?php echo $Cat_ID; ?>" class="btn btn-mini" rel="tooltip" title="New Location Category"><i class="icon-plus"></i></a>
						...
						<div class="box-content nopadding">
                            ...
                            for ($i=0;$i<$tableLength;++$i) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="locations/location-categories.php?sub_id=<?php echo $subCategories[$i]['sub_id'] ?>&cat_id=<?php echo $subCategories[$i]['cat_id']; ?>"><?php echo $subCategories[$i]['subnam'] ?></a></td>
