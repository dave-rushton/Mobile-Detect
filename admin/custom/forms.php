...
$TmpAtr = new AtrDAO();
$attrGroups = $TmpAtr->select(NULL, 'CUSTOM');
		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li>
						<a href="custom/forms.php">Forms</a>
					</li>
				</ul>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<div class="box box-color box-bordered">
						<div class="box-title">
							...
							<div class="actions">
								<a href="custom/forms-edit.php" class="btn btn-mini" rel="tooltip" title="New Form"><i class="icon-plus"></i></a>
							</div>
						</div>
						<div class="box-content nopadding">
							...
							<tbody id="formsBody">
								...
								?>
								<tr>
									<td><a href="<?php $patchworks->pwRoot; ?>custom/forms-edit.php?atr_id=<?php echo $attrGroups[$i]['atr_id']; ?>"><?php echo $attrGroups[$i]['atrnam']; ?></a></td>
									<td>
