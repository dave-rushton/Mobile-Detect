...
if (isset($basketRec) && is_array($basketRec)) {
    ...
    if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'update') {
        ...
        if (!$BskObj) {
            ...
            if(!empty($_POST['bypass_min_order'])){
                $BskObj->bypass_min_order = $_POST['bypass_min_order'];
            }else{
                $BskObj->bypass_min_order = 0;
            }
...
//            }
            ...
            $BskObj->ribcol = $basketRec['ribcol'];
            $BskObj->minord = $basketRec['minord'];
            $BskObj->bypass_min_order = $basketRec['bypass_min_order'];
