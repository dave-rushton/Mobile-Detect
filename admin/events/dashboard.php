...
<script src="bookings/js/dashboard.js"></script>
<style>
			...
			<div class="row-fluid">
				<div class="span8">
					...
					<ul class="tiles">
						...
						<li class="orange <?php echo ($completion > 0) ? 'has-chart' : ''; ?>" style="background: <?php echo $projects[$i]['placol']; ?>">
							...
							<?php } ?>
							<a href="bookings/project-edit.php?cus_id=<?php echo $projects[$i]['tbl_id']; ?>&pla_id=<?php echo $projects[$i]['pla_id'] ?>"> <span>
							<?php if ($completion > 0) { ?>
				...
				<div class="span4">
					...
					<li class="orange" style="background: <?php echo $planned[$i]['placol']; ?>; margin-bottom: 10px;">
						<a href="bookings/project-edit.php?cus_id=<?php echo $planned[$i]['tbl_id']; ?>&pla_id=<?php echo $planned[$i]['pla_id'] ?>">
						<i class="icon-time"></i>
						<div class="details">
