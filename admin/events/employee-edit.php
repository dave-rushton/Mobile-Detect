...
<script src="events/js/employee-edit.js"></script>
</head>
...
<div class="container-fluid" id="content">
	...
	<div id="main">
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<form action="system/people_script.php" id="employeeForm" class="form-horizontal form-bordered" data-returnurl="events/employees.php">
					<div class="span6">
						<div class="box box-color box-bordered">
							...
							<div class="box-content nopadding">
								...
								<input type="hidden" name="tbl_id" value="<?php echo($customerRec) ? $customerRec->pla_id : '0'; ?>">
								<div class="control-group">
									<label class="control-label">Company Name<small>employee company name</small></label>
									<div class="controls">
										<input type="text" class="input-large" name="comnam" value="<?php echo ($peopleRec) ? $peopleRec->comnam : ($customerRec) ? $customerRec->planam : ''; ?>">
									</div>
								</div>
								<div class="control-group">
