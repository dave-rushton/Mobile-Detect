...
//	echo $_REQUEST['enddat'];
	...
	if (!$BooObj) {
        ...
        $BooObj->bootag = (isset($_REQUEST['bootag'])) ? $_REQUEST['bootag'] : '';
        $BooObj->booobj = (isset($_REQUEST['booobj'])) ? $_REQUEST['booobj'] : '';
		...
		$BooObj->reftbl = (isset($_REQUEST['reftbl'])) ? $_REQUEST['reftbl'] : $BooObj->reftbl;
		...
		$BooObj->allday = (isset($_REQUEST['allday']) && is_numeric($_REQUEST['allday'])) ? $_REQUEST['allday'] : $BooObj->allday;
