...
<script src="projects/js/employees.js"></script>
</head>
				...
				<div class="span12">
					<div class="box box-color box-bordered">
						<div class="box-title">
							...
							<div class="actions">
								<a href="projects/employee-edit.php" class="btn btn-mini" rel="tooltip" title="New Employee"><i class="icon-plus"></i></a>
							</div>
						</div>
						<div class="box-content nopadding">
							...
							<table class="table table-bordered table-striped table-highlight" id="employeeTable">
								...
								<tbody>
									...
									?>
									<tr>
										<td><a href="projects/employee-edit.php?ppl_id=<?php echo $employee[$i]['ppl_id'] ?>"><?php echo $employee[$i]['pplnam'] ?></a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
