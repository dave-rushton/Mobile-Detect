...
<script src="projects/js/booking-category-edit.js"></script>
</head>
		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li>
						<a href="projects/booking-category.php">Booking Categories</a>
						<i class="icon-angle-right"></i>
					</li>
					<li>
						<a><?php echo(isset($SubObj)) ? $SubObj->subnam : 'New Booking Category'; ?></a>
					</li>
				</ul>
			</div>
			<div class="row-fluid">
				<div class="span6">
					<div class="box box-color box-bordered">
						<div class="box-title">
							<h3>
								<i class="icon-comments"></i> Booking Category</h3>
							<div class="actions">
						...
						<div class="box-content">
							<form action="system/subcategories_script.php" id="subCategoriesForm" class="form-horizontal" data-returnurl="projects/booking-category.php">
								<input type="hidden" name="sub_id" id="id" value="<?php echo(isset($SubObj)) ? $SubObj->sub_id : '0'; ?>">
								<input type="hidden" name="cat_id" value="<?php echo $Cat_ID; ?>">
								<div class="control-group">
									<label class="control-label">Booking Category Name</label>
									<div class="controls">
