		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li>
						<a><?php echo(isset($order)) ? 'Order #'.str_pad($order->ord_id, 8, "0", STR_PAD_LEFT) : 'New Order'; ?></a>
					</li>
				</ul>
			</div>
                        ...
                        <div class="box-content">
                            <div class="invoice-info">
                                <div class="invoice-name">
                                    ...
                                    <?php echo(isset($order)) ? 'Order #'.str_pad($order->ord_id, 8, "0", STR_PAD_LEFT) : 'New Order'; ?>
                                ...
                                <div class="invoice-from">
                                    ...
                                    <abbr title="Email">Email:</abbr> <?php echo(isset($order)) ? '<a href="mailto:'.$order->emaadr.'">'.$order->emaadr.'</a>' : ''; ?> <br>
                                    <abbr title="Phone">Contact:</abbr> <?php echo(isset($order)) ? $order->paytrm : ''; ?>
                                ...
                                <div class="invoice-to">
                                    ...
                                    <address>
                                        ...
                                        <?php echo(isset($order)) ? $order->pstcod : ''; ?>
                                ...
                                <div class="invoice-infos">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo(isset($order)) ? $order->altnam : ''; ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" id="emailOrderBtn" class="btn" rel="tooltip" title="Email"><i class="icon-envelope"></i></a></td>
                                        </tr>
                ...
                <div class="span12">
                    <div class="box box-color box-bordered">
                        ...
                        <div class="box-content" style="display: none">
                            ...
                            <a href="ecommerce/converttosessionorder.php?ord_id=<?php echo $order->ord_id; ?>" target="_blank">Convert To Session Order</a>

                        </div>
                    </div>

                    <div class="box box-bordered box-color" id="orderEditDiv">
                        <div class="box-title">
                            <h3><i class="icon-envelope"></i> Send Tracking Email</h3>
                        </div>
                        <div class="box-content nopadding">

                            <form action="ecommerce/order-despatched-email.php" id="trackingForm" class="form-horizontal form-bordered">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="input-block-level" name="emaadr" value="<?php echo $order->emaadr;  ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <select name="trkurl" class="input-block-level">
                                                <option value="https://apc-overnight.com/receiving-a-parcel/tracking/" selected>APC</option>
                                                <option value="https://www.parcelhero.com/en-gb/parcel-tracking">Parcel Hero</option>
                                            </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="input-block-level" name="trkcod">
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-primary" name="action" value="send" id="sendTrackingEmailBtn"><i class="icon-save"></i> Send</button>
                                </div>
                            </form>
...
<div class="modal hide fade" id="emailModal">
    ...
    <form action="ecommerce/sendemail_script.php" id="emailForm" class="form-horizontal" novalidate>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" name="action" value="send" id="sendOrderEmailBtn"><i class="icon-save"></i> Send</button>
        </div>
    </form>
</div>

<form action="#" style="display: none" id="orderForm">
    <input type="hidden" name="ord_id" id="id" value="<?php echo $Ord_ID; ?>">
</form>
