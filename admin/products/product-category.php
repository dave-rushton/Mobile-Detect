			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box box-color box-bordered">
						<div class="box-title">
							<h3>
								<i class="icon-comments"></i> Product Categories Categories</h3>
							<div class="actions">
								<a href="products/product-category-edit.php?cat_id=<?php echo $Cat_ID; ?>" class="btn btn-mini" rel="tooltip" title="New Article"><i class="icon-plus"></i></a>
							</div>
						</div>
						<div class="box-content nopadding">
							...
							<tbody>
								...
								?>
								<tr>
									<td><a href="products/product-category-edit.php?sub_id=<?php echo $subCategories[$i]['sub_id'] ?>&cat_id=<?php echo $subCategories[$i]['cat_id']; ?>"><?php echo $subCategories[$i]['subnam'] ?></a></td>
								</tr>
								<?php } ?>
							</tbody>
						</table>
