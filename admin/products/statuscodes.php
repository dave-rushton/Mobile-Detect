...
<script src="products/js/statuscodes.js"></script>
		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li>
						<a href="bookings/dashboard.php">Bookings</a>
						<i class="icon-angle-right"></i>
					</li>
					<li>
						<a>Booking Status</a>
				...
				<div class="span7">
					<div class="box box-color box-bordered">
						...
						<div class="box-content nopadding">
							<form action="products/statuscodes_script.php" id="statusCodeForm" class="form-horizontal form-bordered">
								<input type="hidden" name="sta_id" value="0">
								<input type="hidden" name="tblnam" value="shopping-departments">
