...
//        var_dump($qryArray);
    ...
    function buildStructureOptions ($Par_ID = 0, $SeoUrl = NULL, $Ele_ID = NULL, $EleCls = NULL, $admin = false) {
        ...
        for ($i=0;$i<count($structureRecs);$i++) {
            ...
            echo '<option value="'.$structureRecs[$i]['str_id'].'">';

            echo $structureRecs[$i]['strnam'];

            echo '</option>';

            $this->ShowSubCatsOptions($structureRecs[$i]['str_id'], $SeoUrl, $admin);
    ...
    function ShowSubCatsOptions($Par_ID, $SeoUrl = NULL, $admin = false,$str="")

    {
        ...
        if (count($structureRecs) > 0) {
            ...
            for ($i=0;$i<count($structureRecs);$i++) {
                ...
                echo $str.$structureRecs[$i]['strnam'];

                echo '</option>';

                $this->ShowSubCatsOptions($structureRecs[$i]['str_id'], $SeoUrl, $admin,$str);
    ...
    function getBreadcrumb( $Str_ID=NULL, $SeoUrl = '', $Prt_ID = NULL, $language = NULL ) {
        ...
        if ($parentPage) {
            ...
            $breadCrumbHTML = '<li><a href="'.$this->webRoot.$SeoUrl.'">Products</a></li></li>'.$breadCrumbHTML;
