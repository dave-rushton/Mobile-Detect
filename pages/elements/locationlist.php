...
?>
    ...
    <div class="row" style="margin-bottom: 30px;">
        <div class="col-md-7">
            ...
            <h1><?php echo $locations[$i]['planam']; ?></h1>
        ...
        <div class="col-md-5">
            ...
            <div id="map_canvas_<?php echo $i; ?>" class="mapCanvas" style="width: 100%; height: 300px;" data-goolat="<?php echo $locations[$i]['goolat']; ?>" data-goolng="<?php echo $locations[$i]['goolng']; ?>"></div>
