                    ...
                    <div class="newsItem">
                            ...
                            if (is_array($uploads) && count($uploads) > 0) {
                                ...
                                <a href="<?php echo (!is_null($ParSeo)) ? $ParSeo : $SeoUrl; ?>/article/<?php echo $articles[$i]['seourl'] ?>">
                                    <img class="img-responsive img-hover" src="<?php echo 'uploads/images/750-400/'.$uploads[0]['filnam'] ?>" alt="">
                                </a>
                                <hr>
                            <?php } ?>
	...
	<div class="newsDetail">
		...
		<div id="imageslider" class="flexslider">
			<ul class="slides">
				...
				?>
				<li><?php echo '<img src="uploads/images/750-400/'.$uploads[$i]['filnam'].'" />'; ?></li>
				<?php } ?>
			</ul>
		</div>
