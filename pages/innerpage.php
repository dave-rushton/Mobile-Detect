...
<head>
    ...
    if(empty($image)){
        echo '<meta property="og:image" content="https://tailby.co.uk/uploads/images/p1drqu6ri91galq6mhkk7jnie34.jpg"/>';
    }
    else{
        echo '<meta property="og:image" content="https://tailby.co.uk/"'.$pageHandler->PagImg.'"/>';
    }
    ?>
    <?php
