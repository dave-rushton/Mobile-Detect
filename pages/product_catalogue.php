...
<!---->
<!--                        --><?php
//                        $TmpStr->buildStructure(0, 'shop', NULL);
//                        ?>
<!---->
<!--                    </div>-->
                    ...
                    if ($Str_ID == 0) {
                        ...
                        for ($i = 0; $i < $tableLength; ++$i) {
                            ...
                            <div class="col-md-<?php echo $ColWid; ?> col-xs-6">
                    ...
                    for ($i = 0; $i < $tableLength; ++$i) {
                        ...
                        <div class="col-md-<?php echo $ColWid; ?> col-xs-6">
                            <a href="<?php echo $SeoUrl; ?>/producttype/<?php echo $related[$i]['seourl'] ?>" class="shopCategoryLink">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="productItem">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2><?php echo $productType->prtnam; ?> <span class="productPrice">&pound;<?php echo $productType->unipri; ?></span></h2>
                                <hr/>
                        ...
                        <div class="row">
                                    ...
                                    <ul>
                                        ...
                                        for ($i = 0; $i < $tableLength; ++$i) {
                                            ...
                                            if (
                                                ...
                                                echo '<a href="uploads/images/products/' . $uploads[$i]['filnam'] . '" data-zoomimage="uploads/images/products/' . $uploads[$i]['filnam'] . '" data-arr_id="'.$i.'" data-prd_id="' . $uploads[$i]['tbl_id'] . '" class="selectimage productThumb" style="background-image: url(uploads/images/products/169-130/' . $uploads[$i]['filnam'] . ');">';
                                                echo '<img src="uploads/images/products/169-130/' . $uploads[$i]['filnam'] . '" alt="" /></a>';
                                                echo '<span>'.$uploads[$i]['prdnam'].'</span><br>';

                                            } else {

                                                echo '<a href="uploads/images/products/' . $uploads[$i]['filnam'] . '" data-zoomimage="uploads/images/products/' . $uploads[$i]['filnam'] . '" data-arr_id="'.$i.'" data-prd_id="' . $uploads[$i]['tbl_id'] . '" class="selectimage productThumb">';
                                            ...
                                            echo '<a href="uploads/images/products/' . $uploads[$i]['filnam'] . '"  data-arr_id="'.$i.'" data-prd_id="' . $uploads[$i]['tbl_id'].'" class="viewproduct viewimage">view</a>';
                                            echo '</div>';
                            ...
                            <div class="col-md-3 hidden-sm hidden-xs">
                                ...
                                <?php if (count($uploads) > 0) { ?>
                                    ...
                                    <a href="uploads/images/products/<?php echo $uploads[0]['filnam']; ?>" id="popupImageLink" target="_blank" data-arr_id="0">
                                    <img src="uploads/images/products/<?php echo $uploads[0]['filnam']; ?>" id="popupImage"/>
                                    </a>
...
<script>
    ...
    $(function () {
        ...
        $('.viewimage').click(function(e){
            ...
            $('#popupImage').attr('src', ImgTmp);

            ImgTmp = $(this).attr('href');

            $('#popupImageLink').attr('href', $(this).data('zoomimage')).data('arr_id', $(this).data('arr_id'));
        ...
        $('.viewimage').magnificPopup({
            ...
            callbacks: {
                open: function () {
                    ...
                    startAt = $('#popupImageLink').data('arr_id');
        ...
        $('#productGallery').on('click', '.selectimage', function (e) {
